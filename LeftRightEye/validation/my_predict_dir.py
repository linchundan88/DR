...
dir_dest = '/media/ubuntu/data1/ROP项目/screen/results/LeftRightEye'
...
dicts_models = []
model_dir = '/home/ubuntu/dlp/deploy_models_english_dr/LeftRight'
dict_model1 = {'model_file': os.path.join(model_dir, 'MobileNetV2-005-0.997.hdf5'),
               'input_shape': (224, 224, 3), 'model_weight': 1}
dicts_models.append(dict_model1)
dict_model1 = {'model_file': os.path.join(model_dir, 'NasnetMobile-007-0.991.hdf5'),
               'input_shape': (224, 224, 3), 'model_weight': 1}
dicts_models.append(dict_model1)

filename_csv = os.path.join(dir_dest, 'LeftRightEye_predict_dir.csv')
if GEN_CSV:
