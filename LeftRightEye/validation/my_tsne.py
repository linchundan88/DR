...
model_file = '/home/ubuntu/dlp/deploy_models_english_dr/LeftRight/MobileNetV2-005-0.997.hdf5'
input_shape = (224, 224, 3)
save_tsne_image = "/tmp5/t_sne_2020_5_21/LeftRightEye_tsne.png"
...
draw_tsne(X_tsne, labels, nb_classes=nb_classes, save_tsne_image=save_tsne_image,
          labels_text=['Left eye', 'Right eye'], colors=['g', 'r'])
